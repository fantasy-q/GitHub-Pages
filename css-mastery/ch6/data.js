...
const htmls = [
  ...
  { title: '行内块：文章作者', name: '06-19-inline-block-article-share.html' },
  ...
  { title: '项对齐：自身', name: '06-36-flexbox-navbar-align-self.html' },
  { title: 'Flexbox：', name: '06-37-flexbox-vertical-centering.html' },
  { title: 'Flexbox：', name: '06-38-flexbox-vertical-centering-author-info.html' },
  { title: 'Flexbox：', name: '06-44-flexbox-navbar-flexsize-grow-2-1.html' },
  { title: 'Flexbox：', name: '06-47-flexbox-taglist-wrap.html' },
  { title: 'Flexbox：', name: '06-48-flexbox-taglist-wrap-row-reverse.html' },
  { title: 'Flexbox：', name: '06-49-flexbox-taglist-wrap-reverse-row-reverse.html' },
  { title: 'Flexbox：', name: '06-50-flexbox-taglist-wrap-flex.html' },
  { title: 'Flexbox：', name: '06-52-flexbox-taglist-wrap-flex-max-width.html' },
  { title: 'Flexbox：', name: '06-53-1-flexbox-taglist-wrap-align-content-flex-end.html' },
  { title: 'Flexbox：', name: '06-53-flexbox-taglist-wrap-align-content-stretch.html' },
  { title: 'Flexbox：', name: '06-54-flexbox-column-order-teaser.html' },
  { title: 'Flexbox：', name: '06-57-flexbox-nested-teasers-auto-margin.html' },
  { title: '定位堆叠', name: '06-XX-positioning-stacking-context.html' },
